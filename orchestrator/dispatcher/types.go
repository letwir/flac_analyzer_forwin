...
type TaskPayload struct {
	...
	AnalysisDecision   AnalysisDecision `json:"analysisDecision,omitempty"`
	AnalysisRowID      int64            `json:"analysisRowId,omitzero"`
	AnalysisRowVersion uint64           `json:"analysisRowVersion,omitzero"`
	AnalysisAudioHash  string           `json:"analysisAudioHash,omitempty"`
}
